 ...
 *
 */
class ProProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'detailed_description' => ['type' => 'string', 'length' => 5000, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'detailed_description' => 'Lorem ipsum dolor sit amet'
        ],
    ];
}

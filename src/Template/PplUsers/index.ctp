...
<div class="pplUsers index large-9 medium-8 columns content">
    <h3><?= __('Ppl Users') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $pplUser->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $pplUser->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $pplUser->id], ['confirm' => __('Are you sure you want to delete # {0}?', $pplUser->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>

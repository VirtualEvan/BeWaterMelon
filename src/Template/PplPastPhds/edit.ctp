...
?>
<div class="container">
        <?= $this->Form->create($pplPastPhd, ['templates' => ['inputContainer' => '<div class="col-md-6"><div class="form-group" >{{content}}</div></div>'], 'name' =>'edit']) ?>
        <div class="row">
            ...
            <?php
                ...
                echo $this->Form->control('thesis_name', ['label'=> __('Thesis name'), 'class' => 'form-control', 'pattern' => '.{6,60}']);
                echo $this->Form->control('thesis_link', ['label'=> __('Thesis link'), 'class' => 'form-control', 'pattern' => '(((https?)://)?(\S*?\.\S*?))([\s)\[\]{},;"\':<]|\.\s|$)']);
            ?>
        </div>
